...
var render = function() {
  ...
  return _c("div", { staticClass: "container-fluid" }, [
    _c(
      "div",
      { staticClass: "row" },
      _vm._l(_vm.data, function(datas) {
        return _c(
          "div",
          { key: datas.id, staticClass: "col-lg-4 col-md-6 col-sm-6" },
          [
            _c(
              "div",
              ...
              [
                _c("center", [
                  ...
                  _c("div", { staticClass: "card-header " }, [
                    ...
                    _vm._v(" "),
                    _c("p", [_vm._v(_vm._s(datas.description))])
                  ])
                ]),
                _vm._v(" "),
                _c("h3", { staticClass: "pl-2" }, [
                  _vm._v("Total : " + _vm._s(_vm.formatPrice(datas.total)))
                ]),
                _vm._v(" "),
                _c("div", { staticClass: "card-footer" }, [
                  _c("div", { staticClass: "stats" }, [
                    _c("b", { staticStyle: { color: "black" } }, [
                      _vm._v(_vm._s(datas.created_at))
                    ])
                  ])
                ])
              ],
